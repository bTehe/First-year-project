...
summary(lm.log)$adj.r.squared
summary(lm.sqrt)$adj.r.squared
summary(lm.inv)$adj.r.squared
...
```{r}
# log qqplot
ggplot(data, aes(sample = log(Time))) + stat_qq() + stat_qq_line() + ylab("Sample Quantiles") + xlab("Theoretical Quantiles") + ggtitle("QQ-plot for log transformed data") + theme(plot.title = element_text(hjust = 0.5)) + ylim(-1.5, 8)

# sqrt qqplot
ggplot(data, aes(sample = sqrt(Time))) + stat_qq() + stat_qq_line() + ylab("Sample Quantiles") + xlab("Theoretical Quantiles") + ggtitle("QQ-plot for sqrt transformed data") + theme(plot.title = element_text(hjust = 0.5)) + ylim(-1.5, 8)

# inverse qqplot
ggplot(data, aes(sample = 1/(Time))) + ylab("Sample Quantiles") + xlab("Theoretical Quantiles") + ggtitle("QQ-plot for inversely transformed data") + theme(plot.title = element_text(hjust = 0.5)) + stat_qq() + stat_qq_line() + ylim(-1.5, 8)
